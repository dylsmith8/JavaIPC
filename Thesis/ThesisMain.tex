...
\begin{document}
  ...
  \chapter{Implementation of Windows' IPC Mechanisms}
    \section{Introduction}
      ...
      thereof of each IPC mechanism. In addition, discussion centres around the the various WINAPI
      ...
      of the system. The class loads the native library using the following code:
    ...
    \section{System Compilation and File Generation} \label{syscomp}
