...
REM automates build of a Java socket test program
...
"C:\Program Files (x86)\Java\jdk1.7.0_79\bin\Javac" JavaSocketsWithThread.java

REM run the java interpreter
"C:\Program Files (x86)\Java\jdk1.7.0_79\bin\Java" JavaSocketsWithThread
