...
public class PingPongSocket2
  { private static LinuxIPC ipc = new LinuxIPC();
    ...
    public PingPongSocket2 (String myName) throws IOException
      { this.myName = myName;
    ...
    public static void main(String[] args)
      { startSetup = System.currentTimeMillis();
        ...
        try
          { new PingPongSocket2(myName).play(rounds);
          }
        catch (Exception exc)
    ...
    private void play (int rounds) throws IOException, ClassNotFoundException
      { endSetup = System.currentTimeMillis();
        ...
        if (myName.equals("Ping")) // Report average trip time
          //System.out.println("Average trip time (ns): " + (total/(rounds-1.0)));
          printResults("Sockets2");
