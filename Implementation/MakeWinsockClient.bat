...
REM Script that builds that Winsock client Java program 
...
"C:\Program Files (x86)\Java\jdk1.7.0_79\bin\Javac" WinsockClient.java

REM run the java interpreter
"C:\Program Files (x86)\Java\jdk1.7.0_79\bin\Java" WinsockClient
