...
REM automates build of Mailslot Server
...
"C:\Program Files (x86)\Java\jdk1.7.0_79\bin\Javac" MailslotServer.java

REM run the java interpreter
"C:\Program Files (x86)\Java\jdk1.7.0_79\bin\Java" MailslotServer
