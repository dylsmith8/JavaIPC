...
REM automates build of a Java socket client
...
"C:\Program Files (x86)\Java\jdk1.7.0_79\bin\Javac" JavaSocketsClient.java

REM run the java interpreter
"C:\Program Files (x86)\Java\jdk1.7.0_79\bin\Java" JavaSocketsClient
